...
class mesh_generator:
	...
	def set_outfile(self, out_file):
		self.out_file = out_file
	def set_outfile_fibers(self,out_file):
		self.out_file_fibers = out_file
	def generate_mesh(self, delete_data = True):
		...
		print("Done.")
"""mesh_generator = mesh_generator("heart1.exfile",  "heart_111.vtu")
mesh_generator.set_refinement_fibers(2,2,0)
mesh_generator.set_refinement(1,1,1)
