...
/** 
 *  \defgroup sample_plugin OpenCMISS
 *  \ingroup plugins
...
//	useful defines
	...
	{
		typedef CardiacFibreField<MathVector<dim>, dim> T;
		/*typedef CardiacFibreField<dim> T;*/
		typedef CplUserData<MathVector<dim>, dim> TBase;

		string name = string("CardiacFibreField").append(suffix);
		reg.add_class_<T, TBase>(name, grp)
		   .template add_constructor<void (*)(std::string) >("filename string")

		   .set_construct_as_smart_pointer(true);
		reg.add_class_to_group(name, "CardiacFibreField", tag);
 ...
 */
extern "C" void
InitUGPlugin_OpenCMISS(Registry* reg, string grp)
{
	grp.append("/OpenCMISS");
	typedef OpenCMISS::Functionality Functionality;
